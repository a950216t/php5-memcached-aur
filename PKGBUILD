...
pkgver=2.2.0
pkgrel=4
pkgdesc="php5 extension for interfacing with memcached via libmemcached library"
arch=('i686' 'x86_64')
url="https://pecl.php.net/package/memcached"
license=('PHP')
provides=("php-memcached=${pkgver}-${pkgrel}")
depends=('php5>=5.6.17-3' 'libmemcached')
checkdepends=('memcached')
backup=('etc/php5/conf.d/memcached.ini')
...
package() {
    ...
    echo ';extension=memcached.so' >"$pkgdir/etc/php5/conf.d/memcached.ini"
}
